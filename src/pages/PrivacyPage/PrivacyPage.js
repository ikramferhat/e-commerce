    ...
    <Grid id="privacy">
      ...
      <Container maxWidth="md">
        <div className="privacy-Container">
            <h1>Terms of Use of ShopTemplate.com</h1>
            <p>Please read these terms and conditions carefully before using Our Service.</p>
            <h1>Interpretation and Definitions</h1>
            <h1>Interpretation</h1>
            <p>The words of which the initial letter is capitalized have meanings defined underthe following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            <h1>Definitions</h1>
            ...
            <ul>
              ...
              <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ShopTemplate.com website.</li>
              ...
              <li>Terms and Conditions (also referred as "Terms" or "Terms of Use") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service.</li>
              ...
              <li>Website refers to ShopTemplate.com, accessible from https://www.shoptemplate.com</li>
            ...
            <p>You understand that it is your responsibility to ensure that the privacy policy or any other policies you create with us is complete, accurate, and meets your companies specific privacy needs.</p>
            <p>We are not liable or responsible for any privacy policies or any other policies created using our services, and we give no representations or warranties, express or implied, that the privacy policies or any other policies created using our service are complete, accurate or free from errors or omissions.</p>
            ...
            <h1>Refunds</h1>
            <p>ShopTemplate.com offers the following guarantee. If you purchase a ShopTemplate.com Product, and for some reason you decide that you would like a refund, you have 7 days to request a refund. If you request a refund within 7 days from the date of purchase, ShopTemplate.com will give you a full refund of your purchase price.</p>
            ...
            <h1>Intellectual Property Infringement</h1>
            ...
            <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email (see https://www.shoptemplate.com/contact/) and include in Your notice a detailed description of the alleged infringement.</p>
            ...
            <h1>DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h1>
            ...
            <p>You can contact our copyright agent via email (see https://www.shoptemplate.com/contact/). Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</p>
            ...
            <ul>
              <li>By visiting this page on our website: https://www.shoptemplate.com/contact/</li>
            </ul>         
          </div>
      </Container>
    </Grid>
